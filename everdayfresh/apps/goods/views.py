...
from goods.models import GoodsType,IndexGoodsBanner,IndexPromotionBanner,IndexTtpeGoodsBanner,GoodsSKU
...
class ListView(View):
    ...
    def get(self,request,type_id,page):
        ...
        #获取排序方式
        # 获取分类商品的信息
        #sort=default 按默认排序，为price按商品价格排序，为hot 按销量排序
        ...
        context ={'type':type,'types':types,'skus_page':skus_page,
                  'new_skus':new_skus,'cart_count':cart_count,'sort':sort,'pages':pages}
